...
### O conteudo da pasta SRC são as funções, que já vieram prontas da Trybe, e o objetivo do projeto era desenvolver os testes. Desenvolvi apenas os testes, que estão contidos na pasta 'test'.
